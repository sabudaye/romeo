defmodule Romeo.StanzaTest do
  ...
  test "set_to_roster" do
    assert Stanza.set_to_roster("test@localhost", "none", "test2", "buddies") |> Stanza.to_xml =~
    ...
    assert Stanza.set_to_roster("test@localhost") |> Stanza.to_xml =~
